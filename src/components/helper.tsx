    ...
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-black via-zinc-900 to-black text-zinc-100">
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <section className="text-center py-20 sm:py-28">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight mb-4 bg-clip-text text-transparent bg-gradient-to-b from-white to-zinc-400">
            AI Copilot for Your Data
          </h1>
          <p className="max-w-2xl mx-auto text-lg text-zinc-300/80 mb-8">
          ...
          <div className="flex justify-center gap-4">
            <button
              ...
              className="px-6 py-3 rounded-xl bg-white text-black font-medium hover:bg-zinc-200 transition-transform duration-200 ease-in-out hover:scale-105"
            >
              Get Started
            </button>
          </div>
        ...
        {/* ==================== MAIN APPLICATION UI ==================== */}
        {/* =============================================================== */}
        <div ref={mainContentRef} className="py-10">
          {/* Tab Navigation */}
          ...
          {activeTab === "ask" && (
            <div className="rounded-2xl p-6 mb-8 border border-white/10 bg-white/5 backdrop-blur-xl shadow-[0_0_0_1px_rgba(255,255,255,0.05),0_10px_30px_-10px_rgba(0,0,0,0.6)]">
              ...
              {/* ... (rest of the "Ask Question" JSX is identical) ... */}
          ...
          {activeTab === "upload" && (
            <div className="rounded-2xl p-6 border border-white/10 bg-white/5 backdrop-blur-xl shadow-[0_0_0_1px_rgba(255,255,255,0.05),0_10px_30px_-10px_rgba(0,0,0,0.6)]">
              ...
              {/* ... (rest of the "Upload" JSX is identical) ... */}
              <div className="mb-6">
